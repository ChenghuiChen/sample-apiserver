...
**Note:** go-get or vendor this package as `github.com/ChenghuiChen/sample-apiserver`.
...
`sample-apiserver` is synced from https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/ChenghuiChen/sample-apiserver.
...
```sh
go get -d github.com/ChenghuiChen/sample-apiserver
cd $GOPATH/src/github.com/ChenghuiChen/sample-apiserver  # assuming your GOPATH has just one entry
godep restore
```
...
`kubernetes/staging/src/github.com/ChenghuiChen/sample-apiserver` and its dependencies
