...
mkdir -p ${goPath}/src/github.com/ChenghuiChen/sample-apiserver
cp -R . ${goPath}/src/github.com/ChenghuiChen/sample-apiserver

pushd ${goPath}/src/github.com/ChenghuiChen/sample-apiserver
rm -rf vendor || true
...
mv ${goPath}/src/github.com/ChenghuiChen/sample-apiserver/vendor .
mv ${goPath}/src/github.com/ChenghuiChen/sample-apiserver/Godeps .
git add vendor
git add Godeps
